...
function Email (props) {
  return (
    <svg
      ...
      <title id="simpleicons-mailru-icon">Mail.Ru icon</title>
...
function Skype (props) {
  return (
    <svg
        ...
        role="img" viewBox="0 0 24 24" 
        xmlns="http://www.w3.org/2000/svg">
      <title id="simpleicons-skype-icon">Skype icon</title>
...
function Whatsapp (props) {
  return (
    <svg
        ...
        viewBox="0 0 24 24" 
        xmlns="http://www.w3.org/2000/svg">
      <title id="simpleicons-whatsapp-icon">WhatsApp icon</title>
...
module.exports = {Email, Facebook, GitHub, Linkedin, Skype, Twitter, Whatsapp};